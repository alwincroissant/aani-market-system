                ...
                <form action="{{ route('products.update', $product->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select class="form-select @error('unit_type') is-invalid @enderror" 
                                ...
                                <option value="bundle" {{ old('unit_type', $product->unit_type) == 'bundle' ? 'selected' : '' }}>Bundle</option>
                                <option value="pack" {{ old('unit_type', $product->unit_type) == 'pack' ? 'selected' : '' }}>Pack</option>
                    ...
                    <div class="mb-3">
                        ...
                        @error('stock_quantity')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                        <small class="form-text text-muted">Stock is automatically tracked. Low stock alert triggers when below 5 units.</small>
                    </div>
