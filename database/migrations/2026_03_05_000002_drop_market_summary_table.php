...
return new class extends Migration
{
     ...
     * Run the migrations.
     *
     * Removes the market_summary table which stored aggregated daily market metrics
     * that can be computed dynamically from orders, walk_in_sales, and vendor data.
     */
